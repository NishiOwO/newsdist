...
int nd_init_ssl(void) {
	...
	if((openssl_ctx = SSL_CTX_new(method)) == NULL) return -1;
...
int nd_write_string(nd_pass_t* pass, const char* string) { return nd_write(pass, (void*)string, strlen(string)); }
...
void nd_create_ssl(nd_pass_t* pass) {
